...
fun validate_metadata(
    ...
    if (storage_type == STORAGE_NONE) {
        ...
        // Original object metadata is copied verbatim. Original images may carry
        // any metadata hash (or no hash); Online and Uploaded images must still
        // carry a real 32-byte hash.
        if (source_type != SOURCE_ORIGINAL) {
